...
# ─── Safeguard limits ─────────────────────────────────────────────────────────
HALT_DAILY_LOSS_USD      = 25_000.0   # block + hard-stop if daily PnL hits this
HALT_DRAWDOWN_PCT        = 0.08       # 8% NAV drawdown
HALT_MAX_TRADE_SIZE_PCT  = 0.02       # single trade > 2% NAV blocked
HALT_MAX_OPEN_POSITIONS  = 12
HALT_MAX_LEVERAGE        = 3.0        # total portfolio leverage
...
MOMENTUM_NAV_PCT         = 0.012      # 1.2% NAV
